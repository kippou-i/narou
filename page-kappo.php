...
<div class="topMain_description">
  <p>小説家になろうの活動報告から全文検索できます。</p>
  <p>対象作者のIDを入力することで、特定の作者の活動報告に絞り込んでの検索が可能です。</p>
</div>

<div class="topMain_box">
  <script async src="https://cse.google.com/cse.js?cx=52840e0274e5c48b2"></script>
    ...
    <form id="cse-search-box" class="ncodeForm" action="https://google.com/cse" target="_blank">
      <div class="ncodeForm_inner">
        ...
        <label for="ncode" class="ncodeForm_label">
          <span class="ncodeForm_label_row">作者ID</span>
          <span class="ncodeForm_label_sub ncodeForm_label_row">例：152652<br>活動報告一覧のURLでも◎</span>
        </label>
